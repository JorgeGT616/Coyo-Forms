        ...
        echo"<form method='post' action='../dynamics/php/ValidacionProfesor.php' enctype='multipart/form-data'>
              <fieldset>
                <legend><h3>Ingresa tus datos</h3></legend>
                  ...
                  <p>Nombre: <input type='text' name='NombreProf' placeholder='Ejemplo: Carlos' pattern='[a-zA-ZÑñ]{3,20}' title='Este no es un nombre' required></p>
                  <p>Apellido Paterno: <input type='text' name='apPaternoProf' placeholder='Ejemplo: Perez' pattern='[a-zA-ZÑñ]{3,20}' title='Este no es un apellido, prueba quitandole los acentos' required></p>
                  <p>Apellido Materno: <input type='text' name='apMaternoProf' placeholder='Ejemplo: Hernandez' pattern='[a-zA-ZÑñ]{3,20}' title='Este no es un apellido, prueba quitandole los acentos' required></p>
        ...
        echo"<form method='post' action='../dynamics/php/ValidacionAlumno.php' enctype='multipart/form-data'>
              <fieldset>
                <legend><h3>Ingresa tus datos</h3></legend>
                  ...
                  <p>Nombre: <input type='text' name='NombreAl' placeholder='Ejemplo: Carlos' pattern='[a-zA-ZÑñ]{3,20}' title='Este no es un nombre' required></p>
                  <p>Apellido Paterno: <input type='text' name='apPaternoAl' placeholder='Ejemplo: Perez' pattern='[a-zA-ZÑñ]{3,20}' title='Este no es un apellido, prueba quitandole los acentos' required></p>
                  <p>Apellido Materno: <input type='text' name='apMaternoAl' placeholder='Ejemplo: Hernandez' pattern='[a-zA-ZÑñ]{3,20}' title='Este no es un apellido, prueba quitandole los acentos' required></p>
